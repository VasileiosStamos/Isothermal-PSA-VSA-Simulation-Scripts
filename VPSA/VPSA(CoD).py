...
# CoD defaults
P_mid = config.get("P_mid", 0.4 * 101325.0)
t_cod_end = config.get("t_cod_end", 20.0)
tau_cod = config.get("tau_cod", 10.0)
...
def pde_cod(t, y): 
    ...
    # clamp prevents Jacobian inversions
    ...
    # enforce forward velocity for upwinding
